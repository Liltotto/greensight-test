		...
		<div className="vacancies__filter">
			<div className="vacancies__filter-core">
				<div className="vacancies__filter-items">
					...
					<Dropdown type={'Form'} selected={selectedOptionPosition} setSelected={setSelectedOptionPosition} />
					<Dropdown type={'Position'} selected={selectedOptionForm} setSelected={setSelectedOptionForm} />
				</div>
			...
			{selectedOptionForm != 'Not selected' || selectedOptionPosition != 'Not selected' ?
				<button className="vacancies__filter-clear" onClick={() => { setSelectedOptionForm('Not selected'); setSelectedOptionPosition('Not selected'); }}>
